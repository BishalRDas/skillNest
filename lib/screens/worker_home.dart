        ...
        return ListView(
          ...
          children: [
            ...
            _tile(
              ...
              "Update Charges",
              onTap: () => _editChargesDialog(context, data),
            ),
            _tile(
              Icons.location_on_outlined,
              "Set Work Location",
      ...
      builder: (_) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Container(
            ...
            decoration: BoxDecoration(
              color: const Color(0xffF4F6F9), // 🔥 grey background
              borderRadius: BorderRadius.circular(15),
            ),
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
                ...
                _inputField(skill, "Skill"),
                const SizedBox(height: 12),

                _inputField(exp, "Experience"),
                const SizedBox(height: 12),

                _inputField(charge, "Charges (per hour)", isNumber: true),
              ],
            ),
          ),
        ),
      ...
      builder: (context, snapshot) {
        ...
        return ListView(
          ...
          children: sortedKeys.map((monthKey) {
            ...
            DateTime sampleDate =
                (monthJobs.first.data() as Map<String, dynamic>)['createdAt']
                    .toDate();

            String monthTitle =
                "${_monthName(sampleDate.month)} ${sampleDate.year}";
